  ...
  public static void main(String[] args) throws IOException {
    ...
    while (node != null) {
      ...
      if (state.result == RollResult.SUCCESS) {
        bw.write(Integer.toString(state.depth));
        terminateIO();
        return;
      }
...
class Main {
  ...
  static void queueOffer(State state) {
    queue.offerLast(new Node(state, Direction.UP));
    queue.offerLast(new Node(state, Direction.RIGHT));
    queue.offerLast(new Node(state, Direction.DOWN));
    queue.offerLast(new Node(state, Direction.LEFT));
  }
